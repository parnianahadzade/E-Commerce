...
public class Color extends Base{
    ...
    @JsonView({Views.ColorName.class,Views.singleProduct.class, Views.singleOrder.class})
    private String name;

    @Column(name = "hex_code", nullable = false, length = 20)
    @JsonView({Views.Color.class,Views.singleProduct.class, Views.singleOrder.class})
